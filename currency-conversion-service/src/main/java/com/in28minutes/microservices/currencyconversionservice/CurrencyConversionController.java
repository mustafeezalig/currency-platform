...
//				CurrencyConversion.class, uriVariables);
		...
		CurrencyConversion currencyConversion = restClient.get()
				.uri("http://currency-exchange:8000/currency-exchange/from/{from}/to/{to}", uriVariables).retrieve()
    ...
    @GetMapping("/test")
	public ResponseEntity<?> getTestedApi() {
		return ResponseEntity.status(HttpStatusCode.valueOf(200)).body(Map.of("Status", "Workingfine from conversion"));
	}
